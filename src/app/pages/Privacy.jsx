...
export default function Privacy({ isInline }) {
  const navigate = useNavigate();

  return (
    <div className={isInline ? "" : "min-h-screen bg-[var(--color-background)] text-[var(--color-cream)] pb-24"}>
      {!isInline && (
      ...
      <main className={isInline ? "" : "mx-auto mt-12 max-w-3xl px-6"}>
